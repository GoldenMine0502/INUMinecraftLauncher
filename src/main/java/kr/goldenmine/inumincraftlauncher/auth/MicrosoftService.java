...
import kr.goldenmine.inumincraftlauncher.request.models.MicrosoftTokenResponse;
...
public class MicrosoftService {
    ...
    public static MicrosoftTokenResponse firstLogin(String id, String password) throws InterruptedException, ExecutionException, IOException {
    ...
    public static void getMinecraftSessionId(String accessToken) {
